      ...
      <Divider style={styles.divider}/>
        <TouchableOpacity style={styles.touchableOpacity_row}>
          <View style={styles.user_info_row}>
            ...
            <Label text={"Version"} style={styles.user_info} textStyle={styles.user_nom}/>
          </View>
        ...
        <TouchableOpacity style={styles.touchableOpacity_row}>
          <View style={styles.user_info_row}>
            ...
            <Label text={" Notifications"} style={styles.user_info} textStyle={styles.user_nom}/>
          </View>
          <Ionicons name="chevron-forward-outline" size={24} color="#000" style={{marginHorizontal:20}}/>
        </TouchableOpacity>
        <Divider style={styles.divider}/>
        <TouchableOpacity style={styles.touchableOpacity_row}>
          <View style={styles.user_info_row}>
            ...
            <Label text={"Langues"} style={styles.user_info} textStyle={styles.user_langage}/>
          </View>
          <Ionicons name="chevron-forward-outline" size={24} color="#000" style={{marginHorizontal:20}}/>
        </TouchableOpacity>
         <Divider style={styles.divider}/>
